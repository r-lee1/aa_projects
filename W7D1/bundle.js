...
var _todo_actions = __webpack_require__(147);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODO:
      ...
      return (0, _merge2.default)(state, nextState);
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    todos: (0, _selectors.allTodos)(state) //hold array of todos
  };
};
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (TodoForm.__proto__ || Object.getPrototypeOf(TodoForm)).call(this, { receiveTodo: receiveTodo }));

    _this.receiveTodo = receiveTodo;
    _this.state = {
      id: "",
      title: "",
      body: "",
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          "Title",
          _react2.default.createElement("input", { onChange: this.linkState('title'), type: "text", value: this.state.title })
        ),
        _react2.default.createElement(
          "label",
          null,
          "Body",
          _react2.default.createElement("input", { onChange: this.linkState('body'), type: "text", value: this.state.body })
        ),
        _react2.default.createElement("input", { onClick: this.createTodo.bind(this), type: "submit", value: "Create Todo!" })
      );
    }
  }]);
